...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function fetchTasks() {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=159").then(checkStatus).then(json).then(function (response) {
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=159", {
        method: "POST",
        mode: "cors",
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks/" + id + "?api_key=159", {
        method: "DELETE",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
